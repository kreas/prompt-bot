...
const StandardControls: React.FC<StandardControlsProps> = ({ values, seedLocked, onToggleSeed: handleToggleSeedLock }) => {
  return (
    <div className="form-control">
      ...
      >
        <div className="input-group">
          ...
          <button className="btn btn-square btn-outline btn-primary" type='button' onClick={() => handleToggleSeedLock()}>
            {seedLocked ? (
              <Image src="/icons/lock.svg" width={16} height={16} alt="Locked" />
            ) : (
              <Image src="/icons/unlock.svg" width={16} height={16} alt="Unlocked" />
            )}
          </button>
        </div>
      </FormField>
